...
export class PgSchemaTypeGen {
	...
	getNullableStatus(columnDef) {
		const isPrimaryKey = Object.prototype.hasOwnProperty.call(columnDef, "unique_or_primary") &&
			columnDef.unique_or_primary &&
			columnDef.unique_or_primary === "primary key";
		const isNullable = Object.prototype.hasOwnProperty.call(columnDef, "nullable") &&
			columnDef.nullable &&
	...
	getRequiredStatus(columnDef, nullable) {
		const hasDefaultValue = Object.prototype.hasOwnProperty.call(columnDef, "default_val") &&
