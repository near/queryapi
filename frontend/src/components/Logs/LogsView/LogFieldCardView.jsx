        ...
        <Accordion defaultActiveKey={['0', '1', '2']} alwaysOpen>
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body className="p-0">
              <SeveritySelectorContainer selectedSeverity={severity} onSeverityChange={handleSeverityChange} />
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body className="p-0">
              <LogTypeSelectorContainer selectedLogType={logType} onLogTypeChange={handleLogTypeChange} />
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body className="p-0">
              <DateSelectorContainer selectedDate={dateFilter} onDateChange={handleDateFilter} />
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
      </CustomAccordianWrapper>
