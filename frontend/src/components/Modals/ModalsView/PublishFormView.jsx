...
const PublishFormView = ({
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3">
            ...
            />
            <label htmlFor="startLatest" className="text-gray-700">Start from latest block</label>
        </div>
        ...
        {!isCreateNewIndexer && (
            <div className="flex items-center space-x-3">
                <input
                    ...
                    className="form-radio h-4 w-4 text-gray-600 border-gray-300 focus:ring-gray-500"
                />
                <label htmlFor="startContinue" className="text-gray-700">Continue from last processed block</label>
            </div>
        )}
        ...
        <div className="flex items-center space-x-3">
            <input
                ...
                className="form-radio h-4 w-4 text-gray-600 border-gray-300 focus:ring-gray-500"
            />
            <label htmlFor="startHeight" className="text-gray-700">Start from block height</label>
            <input
                type="number"
                value={blockHeight}
