...
export const INDEXER_REGISTER_TYPE_GENERATION_ERROR = "There was an error generating types from your schema, so the contextDB object cannot be created. Would you like to proceed with registering the Indexer despite this?";
