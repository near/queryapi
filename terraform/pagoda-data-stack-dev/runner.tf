module "queryapi_runner_mainnet_container" {
  ...
  container = {
    args  = []
    image = "us-central1-docker.pkg.dev/pagoda-data-stack-dev/queryapi/queryapi-runner:latest"
...
resource "google_compute_instance" "queryapi_runner_mainnet" {
  ...
  machine_type              = "n2-custom-8-43264"
  zone                      = "europe-west1-b"
...
resource "google_compute_firewall" "queryapi_runner_mainnet_http_access" {
  ...
  # TODO: Remove this firewall without destroying it
  network = "https://www.googleapis.com/compute/v1/projects/pagoda-shared-infrastructure/global/networks/prod"
